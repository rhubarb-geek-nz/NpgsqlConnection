...
namespace RhubarbGeekNz.NpgsqlConnection
{
    [Cmdlet(VerbsCommon.New, "NpgsqlConnection")]
    [OutputType(typeof(DbConnection))]
    public class NewNpgsqlConnection : PSCmdlet
    {
        [Parameter(
            Mandatory = true,
            Position = 0,
        ...
        {
            WriteObject(NpgsqlConnectionFactory.CreateInstance(ConnectionString));
        }
    }
